        ...
        <div class="portlet-body">
                    <div class="portlet-title">
                        <div class="actions">
                                ...
                                <button type="button" class="btn btn-primary pull-right btn-add_units" data-toggle="modal" data-target="#UnitsModal" data-whatever="@mdo"><span class="glyphicon glyphicon-plus-sign"></span> Tambah Data</button>
...
<div class="modal fade portlet box blue" id="UnitsModal" tabindex="-1" role="dialog" aria-labelledby="UnitsModal" aria-hidden="true">
    <div class="portlet-title" id="portletTitle">
            <div class="caption">
                <i class="fa fa-sliders"></i> Form Units </div>
            <div class="tools">
    ...
    <div class="portlet-body form">                                
        <form class="form-horizontal" id="form_units" role="form" method="POST" action="#">            
            ...
            <input type="hidden" name="type" id="type" value="add" readonly>
                ...
                <div class="box-footer form-actions">
                    ...
                    <button type="button" class="btn pull-right btn-danger abort-new-units" data-dismiss="modal">Batal</button> 
                    <button type="button" class="btn pull-right btn-primary save_new-units" id="create" 
